...
crimes_df.DATE = pd.to_datetime(crimes_df.DATE, format='%m/%d/%Y %I:%M:%S%p')#formatting the date
...
print(c_prophet)
c_prophet_df_final = c_prophet_df.rename(columns={'Date':'ds', 'CrimeCount':'y'})
